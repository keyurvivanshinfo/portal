        ...
        <tbody class="table-bordered ">
            @foreach ($images as $key => $image)
                @if ($key % 3 == 0)
                    <tr>
                @endif
                <td><a href="{{ asset('storage/images/'.$image->imagePath)}}"><button class="" value="Download"><img class="mt-3 ms-3 mr-3 mt-3"  style="border-radius: 5px,border:1px solid" src="{{asset('storage/images/'.$image->imagePath)}}" alt="Creative_.ks" height="300" width="400"></a><br>
